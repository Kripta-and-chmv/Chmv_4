        ...
        <table>
            <tr>
                <td class="auto-style3">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="4" AllowPaging="True" AllowSorting="True" AutoGenerateEditButton="True" DataKeyNames="Username" DataSourceID="Users">
                        <Columns>
